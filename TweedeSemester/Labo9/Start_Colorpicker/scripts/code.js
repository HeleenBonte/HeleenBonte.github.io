...
const setColorPickerFromSwatch = (event) => {
    if (event.target.className=="swatch") {
        ...
        document.getElementById("sldRed").value = swatch.getAttribute('red');
        document.getElementById("sldGreen").value = swatch.getAttribute('green');
        document.getElementById("sldBlue").value = swatch.getAttribute('blue');
